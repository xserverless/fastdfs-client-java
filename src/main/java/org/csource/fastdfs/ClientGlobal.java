...
public class ClientGlobal {
    ...
    public static final String PROP_KEY_ADDRESS_MAPPING = "fastdfs.address_mapping";
    ...
    public static Map<String, String> address_mapping;
    ...
    public static void initByProperties(Properties props) throws IOException, MyException {
        ...
        String addressMapping = props.getProperty(PROP_KEY_ADDRESS_MAPPING);
        ...
        address_mapping = new HashMap<String, String>();
        if (addressMapping != null && !addressMapping.trim().isEmpty()) {
            for (String addressMap : addressMapping.split(",")) {
                String[] strings = addressMap.split("=");
                if (strings.length == 2) {
                    address_mapping.put(strings[0], strings[1]);
                }
            }
        }
